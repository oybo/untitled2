package com.qkl.online.mining.app.utils.languagelib;
...
public class MultiLanguageUtil {
    ...
    public int getLanguageType() {
        ...
        int languageType = CommSharedUtil.getInstance(mContext).getInt(MultiLanguageUtil.SAVE_LANGUAGE, LanguageType.LANGUAGE_CHINESE_TRADITIONAL);
