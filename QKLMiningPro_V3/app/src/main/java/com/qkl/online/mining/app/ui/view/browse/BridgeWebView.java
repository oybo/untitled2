...
//        }
        ...
        this.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String url, final String userAgent, final String contentDisposition, final String mimeType, final long contentLength) {
                ...
                if(mWebViewListener != null) {
                    mWebViewListener.onDownloadRequested(url, suggestedFilename, mimeType, contentLength, contentDisposition, userAgent);
                }
            }
        });
    ...
    public void loadUrl(String jsUrl, Map<String, String> additionalHttpHeaders, CallBackFunction returnCallback) {
        if ((!TextUtils.isEmpty(jsUrl) && jsUrl.startsWith("file:")) || additionalHttpHeaders == null) {
            this.loadUrl(jsUrl);
        } else {
    ...
    private ProgressBarWebView.OnWebViewDownloadListener mWebViewListener;

    public void setWebViewListener(ProgressBarWebView.OnWebViewDownloadListener listener) {
        mWebViewListener = listener;
    }

    public ProgressBarWebView.OnWebViewDownloadListener getWebViewListener() {
