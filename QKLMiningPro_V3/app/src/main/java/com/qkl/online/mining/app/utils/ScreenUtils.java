...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * AppContext.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / AppContext.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / AppContext.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * AppContext.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
