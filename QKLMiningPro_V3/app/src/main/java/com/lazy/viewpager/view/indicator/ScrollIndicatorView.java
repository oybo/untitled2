package com.lazy.viewpager.view.indicator;
...
import com.lazy.viewpager.view.indicator.slidebar.ScrollBar;
...
//		}
    ...
    private static class SFixedIndicatorView extends FixedIndicatorView {
        ...
        private int measureChildWidth(View view, int widthSpec, int heightSpec) {
            ...
            int childWidthSpec = ViewGroup.getChildMeasureSpec(widthSpec, getPaddingLeft() + getPaddingRight(), LinearLayout.LayoutParams.WRAP_CONTENT);
