package com.lazy.viewpager.view.indicator.transition;
...
import com.lazy.viewpager.view.indicator.Indicator;
import com.lazy.viewpager.view.utils.ColorGradient;
...
public class OnTransitionTextListener implements Indicator.OnTransitionListener {
    ...
    public final OnTransitionTextListener setColor(int selectColor, int unSelectColor) {
        ...
        gradient = new ColorGradient(
                CommonsUtils.getXmlColor(unSelectColor), CommonsUtils.getXmlColor(selectColor), 100);
        return this;
    }
    ...
    public TextView getTextView(View tabItemView, int position) {
        ...
        return (TextView) tabItemView.findViewById(R.id.view_indicator_txt);
    }
